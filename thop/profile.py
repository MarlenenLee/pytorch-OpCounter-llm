    ...
    def dfs_count(module: nn.Module, prefix="\t") -> (int, int):
        ...
        for n, m in module.named_children():
            ...
            if m in handler_collection and not isinstance(
                ...
                input_shapes = (list(filter(lambda num: num != 0, m.input_shapes[0].tolist())),
                                list(filter(lambda num: num != 0, m.input_shapes[1].tolist())))
                if len(input_shapes[1]) == 0:
